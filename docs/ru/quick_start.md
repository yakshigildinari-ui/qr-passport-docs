...
Раздел содержит пошаговую инструкцию по освоению основного процесса работы в системе QR-Passport – создания моделей оборудования и регистрации изделий. Практический пример поможет быстро освоить ключевые операции QR-Passport.
...
## Задание
### Описание
1. Создать с нуля модель пневмопривода серии VT с наименованием **VT065 S07 F05/07 14 P5021 LLT НЗ** в системе QR-Passport. Компания-изготовитель этих пневмоприводов – VTORK Technology (Wuxi) Co., LTD. 
2. Зарегистрировать 5 изделий с датой изготовления 11/2025 и серийными номерами:
    * 21112025-001;
    * 21112025-002;
    * 21112025-003;
    * 21112025-004;
    * 21112025-005.
3. Скачать паспорта и QR-коды на 5 изделий.
...
При клике на элементы, выделенные голубым цветом (например, `Пневмоприводы`), текст автоматически копируется в буфер обмена.
...
19. Перейдите в конечную подгруппу, где будет находиться модель, в нашем случае это **Серия VT**, чтобы раскрыть список групп, нажмите на значок «**→**».
20. Нажмите кнопку **Редактировать**.
21. В блоке **Модели оборудования** нажмите кнопку **Добавить еще одну модель оборудования**, откроется окно создания модели.
22. Заполните поля этими данными:
    ...
    * _динамические параметры_ – выберите двойным щелчком мыши или перетаскиванием созданные выше динамические параметры;
...
QR-коды тестовых моделей не предназначены для сканирования. После сканирования тестового QR-кода система фиксирует обращение в статистике и модель невозможно будет удалить.
...
1. **Удаление тестовой модели**
   - Перейдите в подраздел **Модели**.
   - Выберите созданную модель **VTORK Technology (Wuxi) Co., LTD**.
   - Нажмите кнопку **Удалить**.
   - Подтвердите удаление, нажав кнопку **Да, я уверен**.

{% note info %}

После удаления модели все привязанные к ней изделия автоматически удаляются, а их QR-коды становятся неактивными.
