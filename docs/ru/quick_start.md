...
19. Раскройте список, нажав на значок «**→**» рядом в наименованием **Пневмоприводы** и перейдите в подгруппу **Серия VT**. В этой подгруппе будет создана модель.
...
22. Заполните поля этими данными:
    ...
    * _инструкция по эксплуатации_ – добавьте скачанное руководство по эксплуатации → [скачать][4];
    * _динамические параметры_ – выберите динамические параметры из п.14-17 двойным щелчком мыши;
    * _документы_ – добавьте скачанный сертификат → [скачать][5], нажав кнопку **Добавить еще один документ**, и добавьте название документа – `Сертификат`.
...
QR-коды тестовых моделей не предназначены для сканирования – используйте их только для ознакомления с функционалом системы. При сканировании тестового QR-кода система автоматически присваивает изделию статус действующего. После этого модель невозможно будет удалить. 
