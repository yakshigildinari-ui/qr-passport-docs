...
{% note info %}
 ...
 ![Динамические параметры_6](../_images/equipment_models_6.png)
...
- Кнопка **Массовая регистрация**
    ...
    * поле **Инкремент** – введите число, на которое будет увеличиваться изменяемая часть серийного номера. 
    
        Например, при инкременте᠎ 1, значение серийного номера будет меняться так: 1234501 → 1234502 → 1234503 и т.д. При инкременте 5, значение серийного номера будет меняться так: 1234501 → 1234506 → 1234511 и т.д.
