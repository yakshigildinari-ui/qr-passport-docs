...
Для просмотра вложенных групп необходимо нажать на значок «**→**» рядом с названием группы. Свернуть группу можно, нажав на значок «**↓**», который появляется после раскрытия.
