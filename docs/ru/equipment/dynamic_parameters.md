...
Динамические параметры задаются на этапе [создания модели](equipment/models.md#anchor), а заполнять данные параметры нужно на этапе [регистрации изделий](equipment/registered_products.md#anchor).
